...
const INNER_CLIP_PATH = 'M15.0787 20.5633L26.5787 87.5633L83.0787 76.5633L79.0787 13.5633L15.0787 20.5633Z';
...
export default function ContactPortrait({ contact, flip }: ContactPortraitProps) {
  ...
  const content = <image href={portraitSrc} x={7} y={8} width={84} height={84} aria-hidden="true" />;
